...
//
        ...
        $field = [
            ...
            Form::radio('is_hot','品牌精选，低价',0)->options([['label'=>'是','value'=>1],['label'=>'否','value'=>0]])->col(8),
            Form::radio('is_benefit','促销单品，特惠',0)->options([['label'=>'是','value'=>1],['label'=>'否','value'=>0]])->col(8),
            ...
            Form::radio('is_market','超市',0)->options([['label'=>'是','value'=>1],['label'=>'否','value'=>0]])->col(8),
            Form::radio('is_newuser_benefit','新人专享',0)->options([['label'=>'是','value'=>1],['label'=>'否','value'=>0]])->col(8),
    ...
    public function edit($id)
    {
        ...
        $field = [
            ...
            Form::radio('is_hot','品牌精选，低价',$product->getData('is_hot'))->options([['label'=>'是','value'=>1],['label'=>'否','value'=>0]])->col(8),
            Form::radio('is_benefit','促销单品，特惠',$product->getData('is_benefit'))->options([['label'=>'是','value'=>1],['label'=>'否','value'=>0]])->col(8),
            ...
            Form::radio('is_market','超市',$product->getData('is_market'))->options([['label'=>'是','value'=>1],['label'=>'否','value'=>0]])->col(8),
            Form::radio('is_newuser_benefit','新人专享',$product->getData('is_newuser_benefit'))->options([['label'=>'是','value'=>1],['label'=>'否','value'=>0]])->col(8),
