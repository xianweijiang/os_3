...
class Renwu extends AuthController
{
    ...
    public function create($id=0 ,$type=1)
    {
        ...
        $field[]= Form::input('exp','经验值积分',isset($vipinfo) ? $vipinfo->exp : '')->col(Form::col(24));
        $field[]= Form::input('fly','社区积分',isset($vipinfo) ? $vipinfo->fly : '')->col(Form::col(24));
        $field[]= Form::input('gong','贡献值积分',isset($vipinfo) ? $vipinfo->gong : '')->col(Form::col(24));
        $field[]= Form::input('buy','购物积分',isset($vipinfo) ? $vipinfo->buy : '')->col(Form::col(24));
        $field[]= Form::input('one','自定义积分1',isset($vipinfo) ? $vipinfo->one : '')->col(Form::col(24));
    ...
    public function set_value($field='',$id='',$value=''){
        ...
        if(SystemRenwu::where(['id'=>$id])->update([$field=>$value]))
