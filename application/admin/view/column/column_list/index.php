                    ...
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" style="width:250px" name="store_name" class="layui-input" placeholder="请输入产品名称,关键字,编号">
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        <button type="button" class="layui-btn layui-btn-xs" onclick="periodical(this)">期刊 <span class="caret"></span></button>
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            <li>
                                <a href="javascript:void(0);" class="" onclick="$eb.createModalFrame(this.innerText,'{:Url('issue_log')}?id={{d.id}}')">
                                    <i class="nfa nfa-nzl"></i> 专栏期刊
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame(this.innerText,'{:Url('column.column_textns/createtext')}?id={{d.id}}')"">
                                  <i class="nfa nfa-ntw"></i> 添加图文期刊
	                            </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame(this.innerText,'{:Url('column.column_textns/createmusics')}?id={{d.id}}')">
                                    <i class="nfa nfa-nyp"></i> 添加音频期刊</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame(this.innerText,'{:Url('column.column_textns/createvideos')}?id={{d.id}}')">
                                    <i class="nfa nfa-nsp"></i> 添加视频期刊</a>
                            </li>
                        </ul>
...
//                    {field: 'status', title: '状态',templet:"#checkboxstatus"},
    ...
    layList.search('export',function(where){
        location.href=layList.U({c:'column.column_list',a:'product_ist',q:{
                cate_id:where.cate_id,
                store_name:where.store_name,
                type:where.type,
                is_type:where.is_type,
                is_column:where.is_column,
                excel:1
            }});
    })
    //下拉框
