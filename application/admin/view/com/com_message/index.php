            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        {switch name='status'}
                            {case value="0"}
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}',{h:document.body.clientHeight,w:document.body.clientWidth})">创建通知</button>
                            {/case}
                            {case value="1"}
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}',{h:document.body.clientHeight,w:document.body.clientWidth})">创建通知</button>
                            {/case}
