                        ...
                        <div class="col-sm-12">
                            <form role="form" onsubmit="return false">
                                <div class="form-group text-right col-sm-12">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" placeholder="版本号如：1.0" class="form-control" id="version" value="{$Version.version}">
                                ...
                                <div class="form-group text-right col-sm-12">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea class="form-control text" rows="10">{$Version.content}</textarea>
                                ...
                                <div class="form-group text-right col-sm-12">
                                    ...
                                    <div class="col-sm-7" style="position: relative">
                                        ...
                                        <input type="hidden" name="zip_nam" id="zip_nam" value="{$Version.zip_name}">
                                        <input type="hidden" name="openfile" id="openfile" value="{$Version.update_file}">
...
<script>
    (function (){
        ...
        $("#submit").click(function () {
            var content=$('.text').val().trim(),zip_name=$('#zip_nam').val().trim(),version=$('#version').val().trim(),id=$('#id').val();
            if(!content){
