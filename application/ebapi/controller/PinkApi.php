...
class PinkApi extends AuthController
{
     ...
     * @autoor jiangxw
     */
    public function get_combination_list_nyb(){
        $data = UtilService::postMore([['page',1],['limit',20]]);
        $store_combination = StoreCombination::getAllNyb($data['page'],$data['limit']);
        return JsonService::successful($store_combination);
    }
    /**
     * TODO 获取拼团列表顶部图
