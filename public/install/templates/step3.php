...
<div class="wrap">
            ...
            <div class="server">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="dbprefix" id="dbprefix" value="osx_" class="input" ></td>
    ...
    <script>
        ...
        var qrcode = new QRCode("qrcode", {
            text: "http://osxh5.demo.opensns.cn/#/pages/backstage/backstage?key="+createKey,
            width: 100,
            height: 100,
            colorDark : "#000000",
            colorLight : "#ffffff",
        ...
        var getSiteCode = setInterval(function () {
            $.ajax({
                url:"https://osxbe.demo.opensns.cn/auth/index/getSiteNumber",
                data:dataform,
                type:'post',
                dataType:'json',
