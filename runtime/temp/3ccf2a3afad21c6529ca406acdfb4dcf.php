<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:109:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/com/com_message/message_reminder.php";i:1597214754;s:93:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/container.php";i:1597214754;s:94:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/frame_head.php";i:1597214754;s:89:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/style.php";i:1597214754;s:96:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/frame_footer.php";i:1597214754;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        <button class="layui-btn layui-btn-xs" onclick="$eb.createModalFrame('编辑','<?php echo Url('edit_template'); ?>?id={{d.id}}')">
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"<?php echo Url('message_reminder_list'); ?>",function (){
        return [
            {type:'checkbox'},
