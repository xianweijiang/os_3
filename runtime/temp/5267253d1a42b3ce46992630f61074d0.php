<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:102:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/store/store_product/index.php";i:1597214754;s:93:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/container.php";i:1597214754;s:94:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/frame_head.php";i:1597214754;s:89:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/style.php";i:1597214754;s:96:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/frame_footer.php";i:1597214754;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="tab">
        <ul class="layui-tab-title">
            ...
            <li lay-id="list" <?php if($type == '4'): ?>class="layui-this" <?php endif; ?>>
                <a href="<?php if($type == '4'): ?>javascript:;<?php else: ?><?php echo Url('index',['type'=>4]); endif; ?>">已经售罄产品(<?php echo $outofstock; ?>)</a>
            </li>
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        <?php switch($type): case "1": if($is_free_ban AND $is_end_ban): ?>
                            <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('create'); ?>',{h:document.body.clientHeight,w:document.body.clientWidth})">添加产品</button>
                            <?php else: ?>
                    ...
                    <script type="text/html" id="act">
                        ...
                        <button type="button" class="layui-btn layui-btn-xs layui-btn-normal" onclick="$eb.createModalFrame('{{d.store_name}}-编辑','<?php echo Url('edit'); ?>?id={{d.id}}',{h:document.body.clientHeight,w:document.body.clientWidth})">
                            编辑
                        </button>
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <?php if(in_array('ebapi_seckill',$open_list)): ?>
                            ...
                            <li>
                                <?php if(in_array('ebapi_ump',$open_list)): ?>
