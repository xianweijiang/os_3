<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:103:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/com/com_message_news/index.php";i:1597214754;s:93:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/container.php";i:1597214754;s:94:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/frame_head.php";i:1597214754;s:89:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/style.php";i:1597214754;s:96:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/frame_footer.php";i:1597214754;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        ...
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('create_message_news'); ?>',{h:document.body.clientHeight,w:document.body.clientWidth})">创建营销消息</button>
                        <?php else: ?>
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"<?php echo Url('message_news_list',['status'=>$status]); ?>",function (){
        var join=new Array();
