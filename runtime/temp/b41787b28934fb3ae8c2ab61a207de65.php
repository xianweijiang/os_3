            ...
            <!--<div class="layui-tab layui-tab-brief" lay-filter="tab">
                <ul class="layui-tab-title">
                    <li lay-id="list" <?php if($type == '1'): ?>class="layui-this" <?php endif; ?> >
                        <a href="<?php if($type == '1'): ?>javascript:;<?php else: ?><?php echo Url('index',['type'=>1]); endif; ?>">底部主导航</a>
                    </li>
                    <li lay-id="list" <?php if($type == '2'): ?>class="layui-this" <?php endif; ?>>
                        <a href="<?php if($type == '2'): ?>javascript:;<?php else: ?><?php echo Url('index',['type'=>2]); endif; ?>">首页导航</a>
                    </li>
                     <li lay-id="list" <?php if($type == '3'): ?>class="layui-this" <?php endif; ?>>
                        <a href="<?php if($type == '3'): ?>javascript:;<?php else: ?><?php echo Url('index',['type'=>3]); endif; ?>">商城首页导航</a>
                    </li>
                </ul>
            </div>-->
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-container">
                        <button type="button" class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('create', ['type'=>$type]); ?>')" style="margin-top: 10px">添加</button>
                    </div>
...
<script>
    ...
    //加载列表
    layList.tableList('List',"<?php echo Url('nav_list',['type'=>$type, 'status'=>$status]); ?>",function (){
        return [
