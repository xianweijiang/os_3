...
<!--                        <div class="hr-line-dashed"></div>-->
                        ...
                        <div class="form-group" style="text-align: center;">
                            <div class="col-sm-4 col-sm-offset-2">
                                <?php if($tab_id == '34'): if(in_array('osapi_video',$open_list)): ?>
                                    <button class="btn btn-primary" type="submit">提交</button>
                                    <?php else: ?>
                                    <button class="btn btn-primary" id="unable" type="submit">提交</button>
                                    <?php endif; elseif($tab_id == '40'): if(in_array('user_invite_rewards',$open_list)): ?>
                                    <button class="btn btn-primary" type="submit">提交</button>
                                    <?php else: ?>
                                    <button class="btn btn-primary" id="unable" type="submit">提交</button>
                                    <?php endif; elseif($tab_id == '90'): if(in_array('website_connect',$open_list)): ?>
                                    <button class="btn btn-primary" type="submit">提交</button>
                                    <?php else: ?>
                                    <button class="btn btn-primary" id="unable" type="submit">提交</button>
                                    <?php endif; elseif($tab_id == '70'): if(in_array('right_copy',$open_list)): ?>
                                    <button class="btn btn-primary" type="submit">提交</button>
                                    <?php else: ?>
                                    <button class="btn btn-primary" id="unable" type="submit">提交</button>
                                    <?php endif; else: ?>
