<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:100:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/order/store_order/index.php";i:1597214754;s:93:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/container.php";i:1597214754;s:94:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/frame_head.php";i:1597214754;s:89:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/style.php";i:1597214754;s:96:"/Applications/MxSrvs/www/yalian-git/osx/osx_admin/application/admin/view/public/frame_footer.php";i:1597214754;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        ...
                        {{#  }else if(d._status==2){ }}
                        <button class="btn btn-primary btn-xs" type="button" onclick="$eb.createModalFrame('去发货','<?php echo Url('deliver_goods'); ?>?id={{d.id}}',{w:document.body.clientWidth,h:document.body.clientHeight})">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a  href="javascript:void(0);" onclick="$eb.createModalFrame('去送货','<?php echo Url('delivery'); ?>?id={{d.id}}',{w:document.body.clientWidth,h:document.body.clientHeight})">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('退款','<?php echo Url('refund_y'); ?>?id={{d.id}}',{w:document.body.clientWidth,h:document.body.clientHeight})">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('退积分','<?php echo Url('integral_back'); ?>?id={{d.id}}',{w:document.body.clientWidth,h:document.body.clientHeight})">
                                    <i class="fa fa-history"></i> 退积分
                                </a>
                            </li>
                            {{#  };}}
                            ...
                            {{# } ;}}
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('拒绝退款','<?php echo Url('refund_n'); ?>?id={{d.id}}',{w:document.body.clientWidht,h:document.body.clientHeight})">
